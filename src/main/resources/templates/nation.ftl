...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <div class="sixteen columns">
            ...
            <!-- Page Title -->
            <div id="page-title">
                <h2>${nation.nationname}<span>/${nation.nationdes}</span></h2>
    ...
    <div class="container">
        ...
        <#list spotList as list>
            ...
            <div class="four columns portfolio-item interior-design architecture real-estate">
                <div class="picture"><a href="${list.cityurl}" rel="image" title="${list.citydes}"><img src="${list.cityurl}" alt="" /><div class="image-overlay-zoom"></div></a></div>
                <div class="item-description alt">
                    <h5><a href="toCity?name=${list.cityname}">${list.cityname}</a></h5>
        ...
        <#--</div>-->
            ...
            <!-- 1/4 Column -->
        <#--<div class="four columns portfolio-item interior-design architecture scenery">-->
        ...
        <#--<div class="four columns portfolio-item architecture scenery">
            ...
            <!-- 1/4 Column -->
        <#--<div class="four columns portfolio-item scenery">
            <div class="picture"><a href="single_project.html"><img src="images/portfolio/portoflio-11.jpg" alt="" /><div class="image-overlay-link"></div></a></div>
            <div class="item-description alt">
            ...
            <!-- 1/4 Column -->
        <#--<div class="four columns portfolio-item interior-design architecture real-estate">
            <div class="picture"><a href="single_project.html"><img src="images/portfolio/portoflio-12.jpg" alt="" /><div class="image-overlay-link"></div></a></div>
            <div class="item-description alt">
